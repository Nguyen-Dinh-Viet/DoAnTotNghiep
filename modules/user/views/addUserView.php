                                    ...
                                    <form method="POST">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="middlename" type="text" name="middlename"
                                                        ...
                                                        class="form-control" placeholder="Nhập tên đệm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="gender" name="gender" class="form-control"
                                                ...
                                                <option <?php if (set_value('gender') == "Nam") {
                                                            echo ("selected");
                                                        } ?> value="Nam">Nam</option>
                                                <option <?php if (set_value('gender') == "Nữ") {
                                                            echo ("selected");
                                                        } ?> value="Nữ">Nữ</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select id="role" name="role" class="form-control"
                                                ...
                                                <option <?php if (set_value('role') == "1") {
                                                            echo ("selected");
                                                        } ?> value="1">Admin</option>
                                                <option <?php if (set_value('role') == "2") {
                                                            echo ("selected");
                                                        } ?> value="2">Cổ đông</option>
                                                <option <?php if (set_value('role') == "3") {
                                                            echo ("selected");
                                        ...
                                        <div class="form-group sub-role">
                                            ...
                                            <input class="form-control" placeholder="Nhập mã số thuế" type="text"
                                                name="tax_code" id="tax_code"
                                                value="<?php echo set_value('tax_code') ?>">
                                            <?php echo form_error('tax_code') ?>
                                        </div>

                                        <div class="form-group sub-role">
                                            <label for="address">Địa chỉ nơi ở</label>
                                            <input class="form-control" placeholder="Nhập địa chỉ nơi ở" type="text"
                                                name="address" id="address" value="<?php echo set_value('address') ?>">
                                            <?php echo form_error('address') ?>
                                        </div>
                                        <div class="form-group form-check">
                                            <input <?php if (set_value('activate') == "1") {
                                                        echo ("checked");
                                                    } ?> class="form-check-input" id="activate" type="checkbox"
                                                value="1" name="activate">
