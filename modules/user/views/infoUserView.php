            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Thông tin cá nhân</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="">Thông tin cá nhân
                            </a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="gender" name="gender" class="form-control" value="<?php if (!empty($_COOKIE['is_login']) || !empty($_SESSION['user_login'])) echo $user['gender']; ?>">
                                                <option <?php if ($user['gender'] == 'Nam' && (!empty($_COOKIE['is_login']) || !empty($_SESSION['user_login']))) {
                                                            echo ("selected");
                                                        } ?> value="Nam">Nam</option>
                                                <option <?php if ($user['gender'] == 'Nữ' && (!empty($_COOKIE['is_login']) || !empty($_SESSION['user_login']))) {
                                                            echo ("selected");
                                                        } ?> value="Nữ">Nữ</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select  disabled="true"  id="role" name="role" class="form-control" value="<?php if (!empty($_SESSION['user_login'])) echo $user['user_role_id']; ?>">
                                                <option <?php if ($user['user_role_id'] == '1' && (!empty($_COOKIE['is_login']) || !empty($_SESSION['user_login']))) {
                                                            echo ("selected");
                                                        } ?> value="1">Admin</option>
                                                <option <?php if ($user['user_role_id'] == '2' && (!empty($_COOKIE['is_login']) || !empty($_SESSION['user_login']))) {
                                                            echo ("selected");
                                                        } ?> value="2">Cổ đông</option>
                                                <option <?php if ($user['user_role_id'] == '3' && (!empty($_COOKIE['is_login']) || !empty($_SESSION['user_login']))) {
                                                            echo ("selected");
