            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Báo cáo tiền lương</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Báo cáo tiền lương</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="page-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block table-border-style">
                                    <form method="POST">
                                        <div class="d-flex mb-3">
                                            <div class="form-inline" style="margin-right: 30%">
                                                ...
                                                <input class="form-control" type="date" name="from_date" id="from_date_salary" value="<?php echo set_value('from') ?>">
                                            </div>
                                            <div class="form-inline mr-5">
                                                <label for="to_date" class="mr-2">Đến</label>
                                                <input class="form-control" type="date" name="to_date" id="to_date_salary" value="<?php echo set_value('to') ?>">
                                            </div>
                                    ...
                                    <!-- <?php
                                            //  show_array($data);
                                            ?> -->
                                    <p style="font-size: 18px;color: #077091;font-weight: 600;">Trả lương tiền Việt Nam đồng (VNĐ)</p>
                                    <?php 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover" id ="table-salary-vnd">
                                            <thead>
                                                <tr>
                                                    <th>STT</th>
                                                    <th>Tên cổ đông</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo (number_format($item['Tong_luong_vnd'], 2, ',', ' ')) ?></td>
                                                        <td class="text-center">
                                                            <span class="watch_detail_salary"  style="cursor: pointer" data-curr ="<?php echo($item['currency']); ?>"  data-id="<?php echo $item['id'] ?>" class="mr-2 change_salary" title="Chi tiết" ><i class="fa fa-eye" aria-hidden="true"></i></span>
                                    ...
                                    <!-- doanh thu đô la -->
                                    <p style="font-size: 18px;color: #176184;font-weight: 600;">Trả lương tiền Đô la Mỹ (USD)</p>
                                    <?php 
                                    ...
                                    ?>
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="table-salary-usd">
                                            <thead>
                                                <tr>
                                                    <th>STT</th>
                                                    <th>Tên cổ đông</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $i ?></th>
                                                        <td><?php echo ($item['user_lname'].' '.$item['user_mname'].' '.$item['user_fname'] ) ?></td>
                                                        <td><?php echo (number_format($item['Tong_luong_usd'], 2, ',', ' ')) ?></td>
                                                        <td class="text-center">
                                                            <span class="watch_detail_salary" style="cursor: pointer"  data-curr ="<?php echo($item['currency']); ?>" data-id="<?php echo $item['id'] ?>" class="mr-2 change_salary" title="Chi tiết" ><i class="fa fa-eye" aria-hidden="true"></i></span>
                            ...
                            <!-- Cấu trưc modal -->
                            <div class="modal fade" id="modal-watch-detail-salary">
...
<script>
    function btn_export_vnd() {
        ...
        var table1 = document.querySelector("#table-salary-vnd");
        var opt = {
            rowIndex: 4
        }; //开头空4行
        ...
        openDownloadDialog(sheet2blob(sheet), 'Bao_cao_luong_vnd.xlsx');
    };
    function btn_export_usd() {
        var from =$("input#from_date_salary").val();
         var to =$("input#to_date_salary").val();
        var table1 = document.querySelector("#table-salary-usd");
        var opt = {
            rowIndex: 4
        }; //开头空4行
        var sheet = XLSX2.utils.table_to_sheet(table1, opt);
        ...
        openDownloadDialog(sheet2blob(sheet), 'Bao_cao_luong_usd.xlsx');
    }
</script>
<?php get_footer(); ?>