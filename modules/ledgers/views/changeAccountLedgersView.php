            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Chỉnh sửa sổ thống kê</h5>
                        <p class="m-b-0">Chỉnh sửa thông tin sổ thống kê</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="">Chỉnh sửa sổ thống kê
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Chỉnh sửa sổ thống kê</h5>
